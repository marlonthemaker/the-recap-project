...
const perks = [
  { name: 'Yesterdays Recap', description: 'We’ll replace it with a new one', icon: CalendarIcon },
  { name: 'Todays Games', description: 'Send it back for free', icon: ArrowPathIcon },
  { name: 'Tomorrows Schedule', description: 'The shipping is on us', icon: TruckIcon },
]
